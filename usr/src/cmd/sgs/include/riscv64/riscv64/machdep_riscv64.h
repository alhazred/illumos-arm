 ...
 */
#define	M_MACH			EM_RISCV
#define	M_MACH_64		EM_RISCV
 ...
 */
#define	M_R_NONE	R_RISCV_NONE
#define	M_R_COPY	R_RISCV_COPY
#define	M_R_RELATIVE	R_RISCV_RELATIVE
#define	M_R_JMP_SLOT	R_RISCV_JUMP_SLOT
#define	M_R_REGISTER	R_RISCV_REGISTER
#define	M_R_NUM		R_RISCV_NUM
