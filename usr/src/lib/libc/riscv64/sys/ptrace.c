...
#define	U_REG		((uintptr_t)(&UP->u_reg[0]))
#define	U_AR0		((uintptr_t)(&UP->u_ar0))
#define	U_PSARGS	((uintptr_t)(&UP->u_psargs[0]))
#define	U_SIGNAL	((uintptr_t)(&UP->u_signal[0]))
#define	U_CODE		((uintptr_t)(&UP->u_code))
#define	U_ADDR		((uintptr_t)(&UP->u_addr))
#define	U_END		((uintptr_t)sizeof (user_t))
...
again:
	...
	case 9:		/* PTRACE_SINGLESTEP */
	{
		...
		if (cp->flags & CS_SETREGS) {
			...
			ps->pr_lwp.pr_reg[REG_RA] = cp->user.u_reg[REG_RA];
			ps->pr_lwp.pr_reg[REG_SP] = cp->user.u_reg[REG_SP];
			ps->pr_lwp.pr_reg[REG_GP] = cp->user.u_reg[REG_GP];
			ps->pr_lwp.pr_reg[REG_TP] = cp->user.u_reg[REG_TP];
			ps->pr_lwp.pr_reg[REG_T0] = cp->user.u_reg[REG_T0];
			ps->pr_lwp.pr_reg[REG_T1] = cp->user.u_reg[REG_T1];
			ps->pr_lwp.pr_reg[REG_T2] = cp->user.u_reg[REG_T2];
			ps->pr_lwp.pr_reg[REG_S0] = cp->user.u_reg[REG_S0];
			ps->pr_lwp.pr_reg[REG_S1] = cp->user.u_reg[REG_S1];
			ps->pr_lwp.pr_reg[REG_A0] = cp->user.u_reg[REG_A0];
			ps->pr_lwp.pr_reg[REG_A1] = cp->user.u_reg[REG_A1];
			ps->pr_lwp.pr_reg[REG_A2] = cp->user.u_reg[REG_A2];
			ps->pr_lwp.pr_reg[REG_A3] = cp->user.u_reg[REG_A3];
			ps->pr_lwp.pr_reg[REG_A4] = cp->user.u_reg[REG_A4];
			ps->pr_lwp.pr_reg[REG_A5] = cp->user.u_reg[REG_A5];
			ps->pr_lwp.pr_reg[REG_A6] = cp->user.u_reg[REG_A6];
			ps->pr_lwp.pr_reg[REG_A7] = cp->user.u_reg[REG_A7];
			ps->pr_lwp.pr_reg[REG_S2] = cp->user.u_reg[REG_S2];
			ps->pr_lwp.pr_reg[REG_S3] = cp->user.u_reg[REG_S3];
			ps->pr_lwp.pr_reg[REG_S4] = cp->user.u_reg[REG_S4];
			ps->pr_lwp.pr_reg[REG_S5] = cp->user.u_reg[REG_S5];
			ps->pr_lwp.pr_reg[REG_S6] = cp->user.u_reg[REG_S6];
			ps->pr_lwp.pr_reg[REG_S7] = cp->user.u_reg[REG_S7];
			ps->pr_lwp.pr_reg[REG_S8] = cp->user.u_reg[REG_S8];
			ps->pr_lwp.pr_reg[REG_S9] = cp->user.u_reg[REG_S9];
			ps->pr_lwp.pr_reg[REG_S10] = cp->user.u_reg[REG_S10];
			ps->pr_lwp.pr_reg[REG_S11] = cp->user.u_reg[REG_S11];
			ps->pr_lwp.pr_reg[REG_T3] = cp->user.u_reg[REG_T3];
			ps->pr_lwp.pr_reg[REG_T4] = cp->user.u_reg[REG_T4];
			ps->pr_lwp.pr_reg[REG_T5] = cp->user.u_reg[REG_T5];
			ps->pr_lwp.pr_reg[REG_T6] = cp->user.u_reg[REG_T6];
...
MakeUser(cstatus_t *cp)
{
	...
	cp->user.u_reg[REG_RA] = ps->pr_lwp.pr_reg[REG_RA];
	cp->user.u_reg[REG_SP] = ps->pr_lwp.pr_reg[REG_SP];
	cp->user.u_reg[REG_GP] = ps->pr_lwp.pr_reg[REG_GP];
	cp->user.u_reg[REG_TP] = ps->pr_lwp.pr_reg[REG_TP];
	cp->user.u_reg[REG_T0] = ps->pr_lwp.pr_reg[REG_T0];
	cp->user.u_reg[REG_T1] = ps->pr_lwp.pr_reg[REG_T1];
	cp->user.u_reg[REG_T2] = ps->pr_lwp.pr_reg[REG_T2];
	cp->user.u_reg[REG_S0] = ps->pr_lwp.pr_reg[REG_S0];
	cp->user.u_reg[REG_S1] = ps->pr_lwp.pr_reg[REG_S1];
	cp->user.u_reg[REG_A0] = ps->pr_lwp.pr_reg[REG_A0];
	cp->user.u_reg[REG_A1] = ps->pr_lwp.pr_reg[REG_A1];
	cp->user.u_reg[REG_A2] = ps->pr_lwp.pr_reg[REG_A2];
	cp->user.u_reg[REG_A3] = ps->pr_lwp.pr_reg[REG_A3];
	cp->user.u_reg[REG_A4] = ps->pr_lwp.pr_reg[REG_A4];
	cp->user.u_reg[REG_A5] = ps->pr_lwp.pr_reg[REG_A5];
	cp->user.u_reg[REG_A6] = ps->pr_lwp.pr_reg[REG_A6];
	cp->user.u_reg[REG_A7] = ps->pr_lwp.pr_reg[REG_A7];
	cp->user.u_reg[REG_S2] = ps->pr_lwp.pr_reg[REG_S2];
	cp->user.u_reg[REG_S3] = ps->pr_lwp.pr_reg[REG_S3];
	cp->user.u_reg[REG_S4] = ps->pr_lwp.pr_reg[REG_S4];
	cp->user.u_reg[REG_S5] = ps->pr_lwp.pr_reg[REG_S5];
	cp->user.u_reg[REG_S6] = ps->pr_lwp.pr_reg[REG_S6];
	cp->user.u_reg[REG_S7] = ps->pr_lwp.pr_reg[REG_S7];
	cp->user.u_reg[REG_S8] = ps->pr_lwp.pr_reg[REG_S8];
	cp->user.u_reg[REG_S9] = ps->pr_lwp.pr_reg[REG_S9];
	cp->user.u_reg[REG_S10] = ps->pr_lwp.pr_reg[REG_S10];
	cp->user.u_reg[REG_S11] = ps->pr_lwp.pr_reg[REG_S11];
	cp->user.u_reg[REG_T3] = ps->pr_lwp.pr_reg[REG_T3];
	cp->user.u_reg[REG_T4] = ps->pr_lwp.pr_reg[REG_T4];
	cp->user.u_reg[REG_T5] = ps->pr_lwp.pr_reg[REG_T5];
	cp->user.u_reg[REG_T6] = ps->pr_lwp.pr_reg[REG_T6];
