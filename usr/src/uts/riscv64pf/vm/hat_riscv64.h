...
/*
 * aarch64 specific routines for use online in setup or aarch64pf/vm files
 */
...
/*
 * Hat switch function invoked to load a new context
 */
extern void hat_switch(struct hat *hat);

extern int hat_page_falt(hat_t *hat, caddr_t vaddr, enum seg_rw rw);
