 ...
 */
#define	HTABLE_NUM_PTES(ht)	(((ht)->ht_level == mmu.max_level) ? NPTEPERPT/ 2: NPTEPERPT)
...
extern pte_t pte_inval(htable_t *ht, uint_t entry, pte_t old, void *ptr, boolean_t tlb);
