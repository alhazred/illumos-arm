...
/*
 * macro to update page list max counts.  no-op on RISC-V.
 */
...
/*
 * interleaved_mnodes mode is never set on RISC-V, therefore,
...
/*
 * get the setsize of the current cpu - assume homogenous for RISC-V
 */
